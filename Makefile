...
AGENT_READ_NO_REPLY_STALE_DAYS ?= 0
...
help:
	...
	@echo "  AGENT_READ_NO_REPLY_STALE_DAYS=$(AGENT_READ_NO_REPLY_STALE_DAYS)"
...
agent-auto-reply: agent-auto-reply-stop cdp-check
	...
	BOSS_RAG_READ_NO_REPLY_STALE_DAYS=$(AGENT_READ_NO_REPLY_STALE_DAYS) \
