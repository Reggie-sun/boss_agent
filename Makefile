...
AGENT_READ_NO_REPLY_MIN_INTERVAL_SECONDS ?= 300
...
help:
	...
	@echo "  AGENT_READ_NO_REPLY_MIN_INTERVAL_SECONDS=$(AGENT_READ_NO_REPLY_MIN_INTERVAL_SECONDS)"
...
agent-auto-reply: cdp-check
	...
	BOSS_RAG_READ_NO_REPLY_FOLLOWUP_MIN_INTERVAL_SECONDS=$(AGENT_READ_NO_REPLY_MIN_INTERVAL_SECONDS) \
