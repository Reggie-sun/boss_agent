...
2. 回答时应区分四种证据来源：
   ...
   * `简历已验证`：来自候选人提供的简历内容。
   * `候选人补充`：来自候选人或当前维护者明确补充、但不在简历原文中的信息。
...
| 候选人补充             | 高   | 简历外直接确认的信息，例如期望薪资、求职偏好补充        |
...
* 工作画像更接近全栈 AI 系统工程师、RAG 应用工程师或偏架构落地的 AI 应用工程师，而不是狭窄的单层模型调用者。
...
| ---------- | -------- | ------------------ |
| 当前薪资       | 未提供      | 不编造                |
| 期望薪资       | 已确认      | 候选人补充为 15k-25k，可直接用于 HR 问答 |
...
当前期望薪资范围是 15k-25k。这一项属于候选人补充信息，不是简历原文；如果 HR 继续追问，可以再结合岗位职责、城市和综合匹配度做具体沟通。
...
5. 到岗时间：一个月内到岗。
6. 地区：湖北。
7. 期望薪资：15k-25k（候选人补充）。
8. 手机：17798303245。
9. 邮箱：[2745124840@qq.com](mailto:2745124840@qq.com)。
...
| 内容        | 处理方式            |
| --------- | --------------- |
| 当前薪资      | 文候选人补充为 9k，可直接回答，但应标注非简历原文     |
| 期望薪资      | 候选人补充为 15k-25k，可直接回答，但应标注非简历原文 |
| 团队人数      | 文档中未提供，不编造      |
| 公司业务收入    | 文档中未提供，不编造      |
| 项目真实用户量   | 文档中未提供，不编造      |
| 项目节省成本    | 文档中未提供，不编造      |
...
13. 期望薪资为 15k-25k，该信息来自候选人补充，不是简历原文。
...
5. 当前期望薪资已更新为 15k-25k；如果后续有调整，应同步更新第 1、2、15、16 节。
