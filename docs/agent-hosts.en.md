...
| LangChain MCP | You want LangChain or LangGraph to discover `boss-mcp` tools over MCP | [LangChain MCP](integrations/langchain-mcp.md) |
...
- Choose `LangChain MCP` when your LangChain or LangGraph runtime should load `boss-mcp` tools directly over MCP
