...
| LangChain MCP | LangChain / LangGraph 通过 MCP 发现 `boss-mcp` 工具 | [LangChain MCP](integrations/langchain-mcp.md) |
...
- 如果你已经在 LangChain / LangGraph 里跑 agent，并且希望直接加载 MCP tools，优先看 `LangChain MCP`
